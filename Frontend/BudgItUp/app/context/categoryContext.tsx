...
export type Expense = {
  ...
  amount: number;
  category: string;
  type: "expense"; // context always stores as expense
};
...
export const CategoryProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <CategoryContext.Provider
      value={{ categories, selectedCategories, toggleCategory, addExpenseToCategory, addCustomCategory, deleteCustomCategory }}
    >
      {children}
    </CategoryContext.Provider>
  );
